    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<div className="flex items-center justify-center h-screen"><Spinner size="lg" /></div>}>
        <Routes>
          ...
          <Route path="/analytics" element={<ProtectedRoute minRole="gdud"><Analytics /></ProtectedRoute>} />
          <Route path="/halacha" element={<ProtectedRoute><QnAPage /></ProtectedRoute>} />
          <Route path="/route-planner" element={<ProtectedRoute minRole="gdud"><RoutePlanner /></ProtectedRoute>} />
          <Route path="/gps-anomalies" element={<ProtectedRoute minRole="gdud"><GpsAnomalies /></ProtectedRoute>} />
          <Route path="/excel" element={<ProtectedRoute minRole="gdud"><ExcelExport /></ProtectedRoute>} />
